...
const EditNumber = () => {
    ...
    const [data, setData] = useState({ number: '', location_id: ''});
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/contact-numbers/${id}`, {
                    headers: {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await axios.put(
                `${process.env.NEXT_PUBLIC_API_URL}/api/contact-numbers/${id}`,
                {
                    number: data.number,
            ...
            router.push(`/admin/contact-numbers/`);
        } catch (err) {
            console.error(err);
