            ...
            <div className="flex-1 p-10 ml-62">
                ...
                <div className="mt-8">
                    <div className="w-full flex justify-between">
                        <h2 className="text-2xl font-bold mb-4">View Reference</h2>
                    ...
                    <div className="bg-white p-4 rounded-md border-gray-200 flex">
                        <div>
                            {data.preview && (
                                <div>
                                    <div>Preview</div>
                                    <Image
                                        src={`${process.env.NEXT_PUBLIC_API_URL}/${data.preview.replace('\\', '/')}`}
                                        alt="Reference"
                                        width={500}
                                        height={400}
                        ...
                        <div className="space-y-10 divide-y-1 ml-4">
                            <div className="mb-10 space-y-4">
                                ...
                                {data.name_tk && (
                                    <div>
                                        <div dangerouslySetInnerHTML={{__html: data.name_tk}}/>
                                    </div>
                                )}
                            </div>
                            <div className="mb-10 space-y-4">
                                ...
                                {data.name_en && (
                                    <div>
                                        <div dangerouslySetInnerHTML={{__html: data.name_en}}/>
                                    </div>
                                )}
                            </div>
                            <div className="mb-10 space-y-4">
                                ...
                                {data.name_ru && (
                                    <div>
                                        <div dangerouslySetInnerHTML={{__html: data.name_ru}}/>
                                    </div>
                                )}
                            </div>
                ...
                {showModal && (
                    <div className="fixed inset-0 flex items-center justify-center bg-opacity-50 z-50">
                        <div className="bg-white p-6 rounded shadow-md w-96">
                            <h2 className="text-lg font-bold mb-4">Remove reference</h2>
                            <p className="mb-6">Are you sure you want to delete this reference?</p>
