...
const EditCookie = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/cookie/${id}`, {
                    headers: {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/api/cookie/${id}`,
                { ...data },
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
