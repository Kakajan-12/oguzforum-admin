        ...
        <div className="admin-page flex">
            ...
            <div className="ml-64 flex-1 p-8 lg:p-10">
                ...
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Contact Locations</h1>
                        <p className="mt-1 text-sm text-gray-500">
                            {locations.length} location{locations.length === 1 ? "" : "s"}
                        </p>
                    </div>
                    <Link href="/admin/contact-address/add-location" className="admin-btn whitespace-nowrap">
                            ...
                            <table className="min-w-full text-sm">
                                ...
                                {locations.map((location) => (
                                    <tr key={location.id} className="transition-colors hover:bg-gray-50">
                                        ...
                                        <td className="px-5 py-3">
                                            <p className="max-w-md text-gray-600">{stripHtml(location.address_en)}</p>
                                        </td>
                                        <td className="px-5 py-3">
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                <Link
                                                    href={`/admin/contact-address/edit-location/${location.id}`}
                                                    className="admin-btn-ghost"
                                                    title="Edit"
                                                >
