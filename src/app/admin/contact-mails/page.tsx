...
import { PencilSquareIcon, PlusIcon, TrashIcon, EnvelopeIcon, MapPinIcon } from "@heroicons/react/16/solid";
        ...
        <div className="admin-page flex">
            ...
            <div className="ml-64 flex-1 p-8 lg:p-10">
                ...
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Contact Mails</h1>
                        <p className="mt-1 text-sm text-gray-500">
                            {mails.length} mail{mails.length === 1 ? "" : "s"}
                        </p>
                    </div>
                    <Link href="/admin/contact-mails/add-mail" className="admin-btn whitespace-nowrap">
                ...
                {mails.length === 0 ? (
                    <div className="admin-card flex flex-col items-center justify-center px-4 py-16 text-center">
                        <EnvelopeIcon className="mb-2 size-10 text-gray-300" />
                        <p className="text-sm text-gray-400">No mails yet.</p>
                    </div>
                ) : (
                                ...
                                {mails.map((mail) => (
                                    <tr key={mail.id} className="transition-colors hover:bg-gray-50">
                                        <td className="px-5 py-3">
                                            <a href={`mailto:${mail.mail}`} className="inline-flex items-center gap-2 font-medium text-gray-800 hover:text-[#1268B3]">
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        <div className="relative w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
                            <div className="mb-4 flex items-center gap-3">
                                ...
                                <h2 className="text-lg font-bold text-gray-900">Delete mail</h2>
                            </div>
                            <p className="mb-6 text-sm text-gray-500">
                                Are you sure you want to delete this contact mail? This action cannot be undone.
                            </p>
